...
(function(global, factory) {
  ...
  function createFrame(config) {
    return {
              ...
              h(
                "Button",
                {
                  on: {
                    click: function click() {
                      return (
                        _this8.onCancel() !== false && _this8.closeModel(true)
                      );
                    },
                  },
                },
      ...
      render: function render() {
        ...
        var type = this.type;
        var node;
        if (type === "input") node = this.makeInput();
        else if (type === "image") node = this.makeImages();
        else node = this.makeFiles();
            ...
            [
              slot
                ? h(
                    ...
                    [is.Function(slot) ? props.slot(h) : slot]
                  )
                : null,
            ]
          );
  ...
  var Tree = {
    ...
    methods: {
      setStatus: function setStatus(value) {
        ...
        this.type === "selected"
          ? this.checked(data, n, "selected")
          : this.checked(data, n, "checked");
        this.$forceUpdate();
      },
      checked: function checked(_data, value, type) {
        ...
        _data.forEach(function(node) {
          ...
          if (node.children !== undefined && Array.isArray(node.children))
            _this.checked(node.children, value, type);
        });
      },
  ...
  function createUpload(config) {
    return {
      ...
      created: function created() {
        ...
        this.formCreateInject.prop.props.defaultFileList = toArray(
          this.value
        ).map(parseFile);
      },
      watch: {
        value: function value(n) {
          if (
            this.$refs.upload.fileList.every(function(file) {
      ...
      methods: {
        ...
        makeIcons: function makeIcons(file, index) {
          ...
          if (this.allowRemove || this.handleIcon !== false) {
            if (
              (this.uploadType !== "file" && this.handleIcon !== false) ||
        ...
        makeFiles: function makeFiles() {
          ...
          return this.uploadList.map(function(file, index) {
            return _this3.$scopedSlots.fileList
              ? _this3.$scopedSlots.fileList({
                  file: file,
                  index: index,
                  vm: _this3,
                })
              : h(
                  ...
                  [
                    file.showProgress
                      ? _this3.makeProgress(file, index)
                      : [
                          _this3.makeItem(file, index),
                          _this3.makeIcons(file, index),
                        ],
                  ]
                );
          });
        ...
        makeUpload: function makeUpload() {
          var h = this.$createElement;
          var isShow =
            !this.maxLength || this.maxLength > this.uploadList.length;
          return h(
            "Upload",
            helper([
              {},
        ...
        update: function update() {
          var files = this.$refs.upload.fileList
            .map(function(file) {
              return file.url;
            })
            .filter(function(url) {
      ...
      render: function render() {
        ...
        return h(
          ...
          [
            [
              this.formCreateInject.prop.props.showUploadList
                ? []
                : this.makeFiles(),
              this.makeUpload(),
            ],
    ...
    return {
      ...
      methods: {
        ...
        addRule: function addRule(i, emit) {
          ...
          options.formData = this.field
            ? _defineProperty({}, this.field, this._value(this.value[i]))
            : this.value[i] || {};
        ...
        del: function del(index, key) {
          if (
            this.disabled ||
            false === this.onBeforeRemove(this.value, index)
          ) {
            return;
          }
        ...
        return keys.length === 0
          ? this.$scopedSlots["default"]
            ...
            : h("Icon", {
                ...
                style: "font-size:"
                  .concat(this.fontSize, "px;vertical-align:middle;cursor:")
                  .concat(
                    this.disabled ? "not-allowed;color:#c9cdd4" : "pointer",
                    ";"
                  ),
                ...
                keys.map(function(key, index) {
                  ...
                  return h(
                    "Row",
                    {
                      ...
                      key: key,
                      style:
                        "border-bottom:1px dashed #dcdee2;margin-bottom:10px;",
                    },
                    [
                      h(
                        "Col",
                          ...
                          h("FormItem", [
                            h(
                              ...
                              helper([
                                ...
                                {
                                  on: {
                                    "update:value": function updateValue(
                                      formData
                                    ) {
  ...
  function attrs() {
    return [].concat(
      keyAttrs,
      _toConsumableArray(normalMerge$1),
      _toConsumableArray(toArrayMerge$1),
      _toConsumableArray(functionalMerge$1),
      arrayAttrs,
      normalAttrs
    );
  }
      ...
      Creator.prototype[name] = function(key) {
        mergeRule(
          ...
          _defineProperty(
            {},
            name,
            arguments.length < 2 ? key : _defineProperty({}, key, arguments[1])
          )
        );
        return this;
      };
  ...
  function uniqueId() {
    return (
      Math.random()
        .toString(36)
        .substr(3, 3) + Number("".concat(Date.now()).concat(++id)).toString(36)
    );
  }
    ...
    extend(Render.prototype, {
      ...
      initOrgChildren: function initOrgChildren() {
        ...
        this.orgChildren = Object.keys(ctxs).reduce(function(initial, id) {
          if (ctxs[id].parser.loadChildren !== false) {
            ...
            initial[id] = is.trueArray(children)
              ? _toConsumableArray(children)
              : [];
          }
      ...
      renderList: function renderList(slot) {
        ...
        return this.sort
          .map(function(id) {
            return slot
              ? _this2.renderSlot(_this2.$handle.ctxs[id], slot)
              : _this2.renderCtx(_this2.$handle.ctxs[id]);
          })
          .filter(function(val) {
      ...
      setTempProps: function setTempProps(vm, ctx) {
        ...
        keys.forEach(function(key) {
          if (hasProperty(prop.props, key)) vm.$props[key] = prop.props[key];
      ...
      renderTemp: function renderTemp(ctx) {
        ...
        if (!this.tempList[id]) {
          ...
          if (ctx.input)
            _vm.$on(
              (_vm.$options.model && _vm.$options.model.event) || "input",
              function(value) {
      ...
      renderId: function renderId(name, type) {
        ...
        var ctxs = this.$handle[type === "field" ? "fieldCtx" : "nameCtx"][
          name
        ];
        return ctxs
      ...
      renderChildren: function renderChildren(ctx) {
        ...
        var isRm = function isRm(child) {
          return (
            !is.String(child) &&
            child.__fc__ &&
            !_this9.$handle.ctxs[child.__fc__.id]
          );
        };
          ...
          if (emitKey) {
            ...
            emit.forEach(function(eventName) {
              ...
              if (!eventInject && inject === false) {
                ...
                var _inject =
                  eventInject || inject || _this2.options.injectEvent;
        ...
        rules.map(function(_rule, index) {
          ...
          var isRepeat = function isRepeat() {
            return !!(
              ...
              _this6.fieldCtx[rule.field][0] !== _rule.__fc__
            );
          };
          ...
          if (ctx.input)
            Object.defineProperty(r, "value", _this6.valueHandle(ctx));
  ...
  function useInput(Handler) {
    extend(Handler.prototype, {
          ...
          set: function set(value) {
            if (_this3.isChange(ctx, value)) {
              _this3.setValue(
                ctx,
                value,
                ctx.parser.toFormValue(value, ctx),
                true
              );
            }
          },
      ...
      isChange: function isChange(ctx, value) {
        return (
          JSON.stringify(ctx.rule.value, strFn) !== JSON.stringify(value, strFn)
        );
      },
  ...
  function useContext(Handler) {
    extend(Handler.prototype, {
              ...
              vm.$watch(
                ...
                function(n, o) {
                  ...
                  if (key === "link") {
                    ...
                    ["props", "on", "nativeOn", "deep"].indexOf(key) > -1
                  ) {
      ...
      rmCtx: function rmCtx(ctx) {
        ...
        input &&
          !this.fieldCtx[field] &&
          this.vm.$emit("removeField", field, ctx.rule, this.api);
      ...
      onEffect: function onEffect(provider) {
        ...
        (provider._c || ["*"]).forEach(function(name) {
          ...
          _this2.bus.$on(
            ...
            function(event, args) {
              provider[event] &&
                provider[event].apply(provider, _toConsumableArray(args));
            }
          );
        });
        provider._used = used;
  ...
  extend(Handler.prototype, {
    ...
    init: function init() {
      this.appendData = _objectSpread2(
        _objectSpread2(
          _objectSpread2({}, this.fc.options.formData || {}),
          this.vm.value || {}
        ),
        this.appendData
      );
  ...
  function CreateNodeFactory() {
    ...
    extend(CreateNode.prototype, {
      ...
      make: function make(tag, data, children) {
        if (Vue.config.isReservedTag(tag) && data.nativeOn)
  ...
  var datePicker = {
    ...
    _toValue: function _toValue(val, ctx) {
      ...
      if (!value) return isRange ? (ctx.el.multiple ? [] : ["", ""]) : value;
      else if (isRange) return value.split(separator);
      else return value;
    },
    toValue: function toValue(formValue, ctx) {
      var el = ctx.el;
  ...
  var manager = {
    ...
    tidyOptions: function tidyOptions(options) {
      ["submitBtn", "resetBtn", "row", "info", "wrap", "col"].forEach(function(
        name
      ) {
    ...
    render: function render(children) {
      ...
      return this.$r(
        this.rule,
        isFalse(this.options.row.show) ? children : [this.makeRow(children)]
      );
    },
        ...
        children[infoProp.align !== "left" ? "unshift" : "push"](
          this.$r(mergeProps([infoProp, prop]), [
            this.$r({
              ...
              props: {
                type:
                  infoProp.icon === true ? iviewConfig.infoIcon : infoProp.icon,
                size: 16,
              },
  ...
  function extendApi(api, h) {
    extend(api, {
      ...
      validateField: function validateField(field, callback) {
        ...
        sub &&
          toArray(sub).forEach(function(form) {
            len++;
            form.validate(function() {
              for (
          ...
          if (valid) {
            ...
            is.Function(failFn) &&
              invoke(function() {
                return failFn.apply(
                  void 0,
                  [_this2].concat(_toConsumableArray(_arguments))
                );
              });
          }
        });
